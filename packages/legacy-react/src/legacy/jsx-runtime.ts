...
import { markVuneNode } from './runtime/jsx-node.js'
import type { Alignment, BorderOptions, FrameOptions, Length } from './types.js'

/** JSX-only values accepted by Vune's custom intrinsic-element runtime. */
export interface VuneJSXProps {
  padding?: Length
  margin?: Length
  gap?: Length
  width?: Length
...
type VuneIntrinsicElements = {
  [K in keyof React.JSX.IntrinsicElements]: React.JSX.IntrinsicElements[K] & VuneJSXProps
}
...
export namespace JSX {
  ...
  export type IntrinsicElements = VuneIntrinsicElements
}

const VUNE_PROPS = new Set([
...
function wrap(factory: (type: any, props: any, key?: any) => ReactElement, type: any, props: any, key?: any) {
  ...
  return markVuneNode(finalElement, { modifiers: modifierNames, layout: native.style })
}
