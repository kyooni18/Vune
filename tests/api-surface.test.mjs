...
test("Vue, Web, and compiler renderer surfaces remain intentionally narrow", () => {
  ...
  assert.deepEqual(Object.keys(compiler).sort(), [
    ...
    "mapGeneratedPosition", "mapOriginalPosition", "parseMuseBuilder", "parseMuseStructs", "resolveSemanticCall", "resolveSemanticInitializer", "semanticHtmlAttributeNames", "semanticHtmlAttributeSpec", "semanticHtmlTagNames", "semanticHtmlTagSpec", "transformMuseSource",
  ])
})
...
test("the 1.0 candidate declaration surface includes type-only exports in the freeze gate", () => {
  ...
  assert.deepEqual(declarationExports("packages/compiler/dist/index.d.ts"), [
    ...
    "lowerMuseBuilderAst", "mapGeneratedPosition", "mapOriginalPosition", "parseMuseBuilder", "parseMuseStructs", "resolveSemanticCall", "resolveSemanticInitializer", "semanticHtmlAttributeNames", "semanticHtmlAttributeSpec", "semanticHtmlTagNames", "semanticHtmlTagSpec", "transformMuseSource",
  ])
})
