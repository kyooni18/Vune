import { Binding, Button, Element, ForEach, GeometryReader, LazyVStack, State, Text, TextField, Toggle, VStack, defineView, initializer } from "muse"
...
const ParityGraph = defineView("ParityGraph", {
  ...
  ForEach(items.value) { item in
    ...
    Element("x-muse-parity", { "data-testid": "custom-element" }, Text("Custom")),
