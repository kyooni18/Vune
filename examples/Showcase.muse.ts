import { Binding, Button, Element, ForEach, Grid, LazyVStack, ProgressView, State, Text, TextField, Toggle, VStack } from "muse"
...
export default view(() => VStack(spacing: 18) {
  ...
  <header class="showcase-hero" data-testid="showcase-hero">
    <span class="showcase-kicker">MUSE SHOWCASE</span>
  </header>

  Text("Framework health dashboard")
    .className("showcase-title")
  Text("A medium-sized Muse app exercising state, builders, collections, modifiers, HTML, and async actions.")
